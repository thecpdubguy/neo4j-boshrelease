...
Pipeline running at ${CONCOURSE_URL}/neo4j-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml neo4j-boshrelease --paused=false
```
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml neo4j-boshrelease-image --paused=false
```
